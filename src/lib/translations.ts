...
export const translations = {
  en: {
    ...
    project1Desc: "A scalable cloud architecture for real-time data processing.",
  ...
  es: {
    ...
    project1Desc: "Una arquitectura en la nube escalable para procesamiento de datos en tiempo real.",
